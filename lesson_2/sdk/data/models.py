...
class Networks:
    ...
    Fantom = Network(
        ...
        api=API(
            key=config.FANTOM_API_KEY, url='https://api.ftmscan.com/api', docs='https://ftmscan.com/apis'
        )
    )
    ...
    Gnosis = Network(
        ...
        api=API(
            key=config.GNOSIS_API_KEY, url='https://api.gnosisscan.io/api', docs='https://gnosisscan.io/apis'
        )
    )

    # todo: сделать самостоятельно
    HECO = Network(
        name='huobi_eco_chain_mainnet',
        ...
        api=API(
            ...
            docs='https://scan.hecochain.com/en-us/apis')
    )
